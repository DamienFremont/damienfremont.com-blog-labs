Comment faire des accordéons dans des lignes de tableau en Twitter Bootstrap ? Nous verrons que la table pour faire …un tableau n’est pas une si bonne idée !
Objectif
...
L’ajout de boutons entre également en conflit avec le collapse/expand.
